...
namespace TrackerLibrary.DataAcces.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // id, team name, list of id's separted by the pipe
            // 3, Tim's team, 1|3|5
        ...
        public static void SaveRoundsToFile(this TournamentModel model, string MatchupFile, string MatchupEntryFile)
        {
            ...
            // loop through each machtup
            // get the id for the new macthup and save the record
        ...
        {
            // id=0, entries=1(pipe delimited by id), winner=2, macthupRound=3
        ...
        public static void SaveEntryToFile(this MatchupEntryModel entry, string MatchupEntryFile)
        {
            ...
            // id = 0, TeamCompeting = 1, Score = 2, ParentMacthup = 3
